...
func New(ds *storage.DB, version string, log *slog.Logger) *server.MCPServer {
	...
	s.AddTools(
		...
		server.ServerTool{Tool: toolGetStrengthSummary, Handler: h.getStrengthSummary},
		server.ServerTool{Tool: toolGetStrengthIntensity, Handler: h.getStrengthIntensity},
		server.ServerTool{Tool: toolGetStrengthVolume, Handler: h.getStrengthVolume},
		server.ServerTool{Tool: toolGetStrengthE1RM, Handler: h.getStrengthE1RM},
